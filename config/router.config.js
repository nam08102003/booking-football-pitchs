...
module.exports.routes = {
  ...
  web: [
    ...
    { path: '/book', name: 'book', component: 'book/index' },
    { path: '/blog', name: 'blog', component: 'blog/index' },
    { path: '/book/:id', name: 'detail', component: 'book/[id]/index' },
    {
      path: '/blog/detail/:id',
      name: 'blogDetail',
      component: 'blog/deatil/[id]/index',
    },
